...
class APIView(ObjectMultipleModelAPIView):
    ...
    querylist = [
        {'queryset': models.StudentExtra.objects.all(), 'serializer_class': serializers.StudentSerializer},
        {'queryset':  models.TeacherExtra.objects.all(), 'serializer_class': serializers.TeacherSerializer},
    ]
...
# for showing signup/login button for teacher(MomoWade)
...
def teacherclick_view(request):
    if request.user.is_authenticated:
        return HttpResponseRedirect('afterlogin')
    return render(request, 'professeur/teacherclick.html')


# for showing signup/login button for student(MomoWade)
def studentclick_view(request):
    if request.user.is_authenticated:
        return HttpResponseRedirect('afterlogin')
    return render(request, 'eleve/studentclick.html')
...
def student_signup_view(request):
    ...
    return render(request, 'eleve/studentsignup.html', context=mydict)
...
def teacher_signup_view(request):
    ...
    return render(request, 'professeur/teachersignup.html', context=mydict)


# for checking user is techer , student or admin(MomoWade)
def is_admin(user):
...
def afterlogin_view(request):
    if is_admin(request.user):
        ...
        if accountapproval:
            ...
            return render(request, 'professeur/teacher_wait_for_approval.html')
    elif is_student(request.user):
        accountapproval = models.StudentExtra.objects.all().filter(user_id=request.user.id, status=True)
        if accountapproval:
            return redirect('student-dashboard')
        else:
            return render(request, 'eleve/student_wait_for_approval.html')


# for dashboard of adminnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn(MomoWade)
...
def admin_dashboard_view(request):
    ...
    # aggregate function return dictionary so fetch data from dictionay(MomoWade)
    mydict = {
...
# for teacher sectionnnnnnnn by adminnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn(MomoWade)
...
# for student by adminnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn(MomoWade)
...
# attendance related viewwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(MomoWade)
@login_required(login_url='adminlogin')
@user_passes_test(is_admin)
...
# fee related view by adminnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn(MomoWade)
@login_required(login_url='adminlogin')
@user_passes_test(is_admin)
...
# notice related viewsssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss(MomoWade)
@login_required(login_url='adminlogin')
@user_passes_test(is_admin)
def admin_notice_view(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            form.by = f'{request.user.first_name.capitalize()} {request.user.last_name.capitalize()}'
            form.save()
            return redirect('admin-dashboard')
    return render(request, 'admin/admin_notice.html', {'form': form})


# for TEACHER  LOGIN    SECTIONNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNN(MomoWade)
...
def teacher_dashboard_view(request):
    ...
    return render(request, 'professeur/teacher_dashboard.html', context=mydict)


@login_required(login_url='teacherlogin')
@user_passes_test(is_teacher)
def teacher_attendance_view(request):
    return render(request, 'professeur/teacher_attendance.html')
...
def teacher_take_attendance_view(request, cl):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            print('form invalid')
    return render(request, 'professeur/teacher_take_attendance.html', {'students': students, 'aform': aform})
...
def teacher_view_attendance_view(request, cl):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            studentdata = models.StudentExtra.objects.all().filter(cl=cl)
            mylist = zip(attendancedata, studentdata)
            return render(request, 'professeur/teacher_view_attendance_page.html',
                          {'cl': cl, 'mylist': mylist, 'date': date})
        else:
            print('form invalid')
    return render(request, 'professeur/teacher_view_attendance_ask_date.html', {'cl': cl, 'form': form})
...
def teacher_notice_view(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            print('form invalid')
    return render(request, 'professeur/teacher_notice.html', {'form': form})


# FOR STUDENT AFTER THEIR Loginnnnnnnnnnnnnnnnnnnnn(MomoWade)
...
def student_dashboard_view(request):
    ...
    return render(request, 'eleve/student_dashboard.html', context=mydict)
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            attendancedata = models.Attendance.objects.all().filter(date=date, cl=studentdata[0].cl,
                                                                    roll=studentdata[0].roll)
            mylist = zip(attendancedata, studentdata)
            return render(request, 'eleve/student_view_attendance_page.html', {'mylist': mylist, 'date': date})
        else:
            print('form invalid')
    return render(request, 'eleve/student_view_attendance_ask_date.html', {'form': form})


# for aboutus and contact ussssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss (MomoWade)
