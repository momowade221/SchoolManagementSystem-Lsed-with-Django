...
from LSED import views
from django.contrib.auth.views import LoginView,LogoutView
from LSED.views import *
...
urlpatterns = [
    ...
    path('studentlogin', LoginView.as_view(template_name='eleve/studentlogin.html')),
    path('teacherlogin', LoginView.as_view(template_name='professeur/teacherlogin.html')),
